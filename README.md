...
| <a name="style_color"></a>style_color | `string`           | `#000000`     | <`#000000`; `#FFFFFF`>                         | Base color for QR Code modules referred as RGB triple value presented as hex number. Can be obtained from [w3schools.com](https://www.w3schools.com/colors/colors_picker.asp).                                                                                                                                                                                                                                                               |
...
| inner_eye_color                       | `string`           | `None`        | <`#000000`; `#FFFFFF`>                         | Base color for inner QR Code eyes. If this value is set to `None`, base color is inherited from data modules color (see parameter: [style_color](#style_color)).                                                                                                                                                                                                                                                                             |
